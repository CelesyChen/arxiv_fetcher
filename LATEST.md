# ArXiv 新论文更新（2025-11-04)

### [AMD MI300X GPU Performance Analysis](https://arxiv.org/abs/2510.27583)
**作者**：Chandrish Ambati, Trung Diep
...
### [Dependence-Driven, Scalable Quantum Circuit Mapping with Affine Abstractions](https://arxiv.org/abs/2510.27067)
**作者**：Marouane Benbetka, Merwan Bekkar, Riyadh Baghdadi, Martin Kong
...
### [Graph-Based Product Form](https://arxiv.org/abs/2502.13890)
**作者**：C\'eline Comte, Isaac Grosof
...
### [Choreographer: A Full-System Framework for Fine-Grained Tasks in Cache Hierarchies](https://arxiv.org/abs/2510.26944)
**作者**：Hoa Nguyen, Pongstorn Maidee, Jason Lowe-Power, Alireza Kaviani
...
### [A Memory-Efficient Retrieval Architecture for RAG-Enabled Wearable Medical LLMs-Agents](https://arxiv.org/abs/2510.27107)
**作者**：Zhipeng Liao, Kunming Shao, Jiangnan Yu, Liang Zhao, Tim Kwang-Ting Cheng, Chi-Ying Tsui, Jie Yang, Mohamad Sawan
...
### [HPIM: Heterogeneous Processing-In-Memory-based Accelerator for Large Language Models Inference](https://arxiv.org/abs/2509.12993)
**作者**：Cenlin Duan, Jianlei Yang, Rubing Yang, Yikun Wang, Yiou Wang, Lingkun Long, Yingjie Qi, Xiaolin He, Ao Zhou, Xueyan Wang, Weisheng Zhao
...
### [Practical Timing Closure in FPGA and ASIC Designs: Methods, Challenges, and Case Studies](https://arxiv.org/abs/2510.26985)
**作者**：Mostafa Darvishi
...
### [Descriptor-Based Object-Aware Memory Systems: A Comprehensive Review](https://arxiv.org/abs/2510.27070)
**作者**：Dong Tong
...
### [Benchmarking Ultra-Low-Power $\mu$NPUs](https://arxiv.org/abs/2503.22567)
...
### [FlowMesh: A Service Fabric for Composable LLM Workflows](https://arxiv.org/abs/2510.26913)
**作者**：Junyi Shen, Noppanat Wadlom, Lingfeng Zhou, Dequan Wang, Xu Miao, Lei Fang, Yao Lu
...
### [A Cloud-Based Spatio-Temporal GNN-Transformer Hybrid Model for Traffic Flow Forecasting with External Feature Integration](https://arxiv.org/abs/2510.27039)
...
### [A Digital Twin-based Multi-Agent Reinforcement Learning Framework for Vehicle-to-Grid Coordination](https://arxiv.org/abs/2510.27289)
**作者**：Zhengchang Hua, Panagiotis Oikonomou, Karim Djemame, Nikos Tziritas, Georgios Theodoropoulos
...
### [Dynamic Service Scheduling and Resource Management in Energy-Harvesting Multi-access Edge Computing](https://arxiv.org/abs/2510.27317)
**作者**：Shuyi Chen, Panagiotis Oikonomou, Zhengchang Hua, Nikos Tziritas, Karim Djemame, Nan Zhang, Georgios Theodoropoulos
...
### [ML-Based Optimum Sub-system Size Heuristic for the GPU Implementation of the Tridiagonal Partition Method](https://arxiv.org/abs/2510.27351)
**作者**：Milena Veneva
...
### [Recognizing Hereditary Properties in the Presence of Byzantine Nodes](https://arxiv.org/abs/2312.07747)
**作者**：David Cifuentes-N\'u\~nez, Pedro Montealegre, Ivan Rapaport
...
### [High-Performance Statistical Computing (HPSC): Challenges, Opportunities, and Future Directions](https://arxiv.org/abs/2508.04013)
...
**作者**：Yunzhao Yang, Runhui Wang, Xuanqing Liu, Adit Krishnan, Yefan Tao, Yuqian Deng, Kuangyou Yao, Peiyuan Sun, Henrik Johnson, Aditi sinha, Davor Golac, Gerald Friedland, Usman Shakeel, Daryl Cooke, Joe Sullivan, Chris Kong
...
**作者**：Zhibin Wang, Zhonghui Zhang, Yuhang Zhou, Zibo Wang, Mo Zhou, Peng Jiang, Weilin Cai, Chengying Huan, Rong Gu, Sheng Zhong, Chen Tian
...
### [Secure Communication in the Presence of an RIS-Enhanced Eavesdropper in MIMO Networks](https://arxiv.org/abs/2510.27147)
**作者**：Gaoyuan Zhang, Ruisong Si, Boyuan Li, Zijian Li, Baofeng Ji, Chenqi Zhu, Tony Q. S. Quek
...
### [Byzantine Attacks in RIS-Enhanced Cooperative Spectrum Sensing: A Decision Fusion Perspective](https://arxiv.org/abs/2510.27175)
**作者**：Gaoyuan Zhang, Gaolei Song, Boyuan Li, Zijian Li, Baofeng Ji, Ruijuan Zheng, Guoqiang Zheng, Tony Q. S. Quek
...
### [SERFLOW: A Cross-Service Cost Optimization Framework for SLO-Aware Dynamic ML Inference](https://arxiv.org/abs/2510.27182)
...
### [Hybrid Decentralized Optimization: Leveraging Both First- and Zeroth-Order Optimizers for Faster Convergence](https://arxiv.org/abs/2210.07703)
**作者**：Matin Ansaripour, Shayan Talaei, Giorgi Nadiradze, Dan Alistarh
...
### [Resource-Adaptive Successive Doubling for Hyperparameter Optimization with Large Datasets on High-Performance Computing Systems](https://arxiv.org/abs/2412.02729)
...
### [Hybrid Dual-Batch and Cyclic Progressive Learning for Efficient Distributed Training](https://arxiv.org/abs/2509.26092)
...
### [Sockeye: a language for analyzing hardware documentation](https://arxiv.org/abs/2510.27485)
...
### [A Practical-Driven Framework for Transitioning Drive-by-Wire to Autonomous Driving Systems: A Case Study with a Chrysler Pacifica Hybrid Vehicle](https://arxiv.org/abs/2410.06492)
