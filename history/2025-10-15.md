# ArXiv 新论文更新（2025-10-15)

### [Analysis and Evaluation of Using Microsecond-Latency Memory for In-Memory Indices and Caches in SSD-Based Key-Value Stores](https://arxiv.org/abs/2510.12280)
**作者**：Yosuke Bando, Akinobu Mita, Kazuhiro Hiwada, Shintaro Sano, Tomoya Suzuki, Yu Nakanishi, Kazutaka Tomida, Hirotsugu Kajihara, Akiyuki Kaneko, Daisuke Taki, Yukimasa Miyamoto, Tomokazu Yoshida, Tatsuo Shiozawa
...
### [Should I Run My Cloud Benchmark on Black Friday?](https://arxiv.org/abs/2510.12397)
**作者**：S\"oren Henning, Adriano Vogel, Esteban Perez-Wohlfeil, Otmar Ertl, Rick Rabiser
...
### [TALP-Pages: An easy-to-integrate continuous performance monitoring framework](https://arxiv.org/abs/2510.12436)
**作者**：Valentin Seitz, Jordy Trilaksono, Marta Garcia-Gasulla
...
**作者**：Peter Alvaro, Rebecca Isaacs, Rupak Majumdar, Kiran-Kumar Muniswamy-Reddy, Mahmoud Salamati, Sadegh Soudjani
...
### [Accelerating Sparse Ternary GEMM for Quantized ML on Apple Silicon](https://arxiv.org/abs/2510.06957)
**作者**：Baraq Lipshitz, Alessio Melone, Charalampos Maraziaris, Muhammed Bilal
...
### [A Direct Memory Access Controller (DMAC) for Irregular Data Transfers on RISC-V Linux Systems](https://arxiv.org/abs/2510.12277)
**作者**：Thomas Benz, Axel Vanoni, Michael Rogenmoser, Luca Benini
...
### [FlexPipe: Adapting Dynamic LLM Serving Through Inflight Pipeline Refactoring in Fragmented Serverless Clusters](https://arxiv.org/abs/2510.11938)
...
### [Comparing Cross-Platform Performance via Node-to-Node Scaling Studies](https://arxiv.org/abs/2510.12166)
...
### [GPU-Accelerated Algorithms for Process Mapping](https://arxiv.org/abs/2510.12196)
**作者**：Petr Samoldekin, Christian Schulz, Henning Woydt
...
### [Metronome: Efficient Scheduling for Periodic Traffic Jobs with Network and Priority Awareness](https://arxiv.org/abs/2510.12274)
**作者**：Hao Jiang, Meng Qin, Ruijie Kuai, Dandan Liang
...
### [A Non-Intrusive Framework for Deferred Integration of Cloud Patterns in Energy-Efficient Data-Sharing Pipelines](https://arxiv.org/abs/2510.12354)
**作者**：Sepideh Masoudi, Mark Edward Michael Daly, Jannis Kiesel, Stefan Tai
...
### [Low Latency, High Bandwidth Streaming of Experimental Data with EJFAT](https://arxiv.org/abs/2510.12597)
**作者**：Ilya Baldin, Michael Goodrich, Vardan Gyurjyan, Graham Heyes, Derek Howard, Yatish Kumar, David Lawrence, Brad Sawatzky, Stacey Sheldon, Carl Timmer
...
**作者**：Evelyne Ringoot, Rabab Alomairy, Alan Edelman
...
### [Rationally Analyzing Shelby: Proving Incentive Compatibility in a Decentralized Storage Network](https://arxiv.org/abs/2510.11866)
**作者**：Michael Crystal, Guy Goren, Scott Duke Kominers
...
### [PubSub-VFL: Towards Efficient Two-Party Split Learning in Heterogeneous Environments via Publisher/Subscriber Architecture](https://arxiv.org/abs/2510.12494)
...
### [Personalized Federated Fine-Tuning of Vision Foundation Models for Healthcare](https://arxiv.org/abs/2510.12741)
**作者**：Adam Tupper, Christian Gagn\'e
...
### [LLMBridge: Reducing Costs in a Prompt-Centric Internet](https://arxiv.org/abs/2410.11857)
...
### [WW-FL: Secure and Private Large-Scale Federated Learning](https://arxiv.org/abs/2302.09904)
**作者**：Felix Marx, Thomas Schneider, Ajith Suresh, Tobias Wehrle, Christian Weinert, Hossein Yalame
