# ArXiv 新论文更新（2025-11-07)

### [PerfDojo: Automated ML Library Generation for Heterogeneous Architectures](https://arxiv.org/abs/2511.03586)
...
### [Performance Evaluation of Bitstring Representations in a Linear Genetic Programming Framework](https://arxiv.org/abs/2511.02897)
...
### [Exploring Topologies in Quantum Annealing: A Hardware-Aware Perspective](https://arxiv.org/abs/2511.03327)
...
### [LogicSparse: Enabling Engine-Free Unstructured Sparsity for Quantised Deep-learning Accelerators](https://arxiv.org/abs/2511.03079)
...
### [An Event-Driven Spiking Compute-In-Memory Macro based on SOT-MRAM](https://arxiv.org/abs/2511.03203)
**作者**：Deyang Yu, Chenchen Liu, Chuanjie Zhang, Xiao Fang, Weisheng Zhao
...
### [Design and Optimization of Mixed-Kernel Mixed-Signal SVMs for Flexible Electronics](https://arxiv.org/abs/2511.03427)
**作者**：Florentia Afentaki, Maha Shatta, Konstantinos Balaskas, Georgios Panagopoulos, Georgios Zervakis, Mehdi B. Tahoori
...
### [FPGA-based Emulation and Device-Side Management for CXL-based Memory Tiering Systems](https://arxiv.org/abs/2502.19233)
**作者**：Yiqi Chen, Xiping Dong, Zhe Zhou, Zhao Wang, Jie Zhang, Guangyu Sun
...
### [LM-Fix: Lightweight Bit-Flip Detection and Rapid Recovery Framework for Language Models](https://arxiv.org/abs/2511.02866)
...
#### cs.SE, cs.AI, cs.AR, cs.CR

### [SnapStream: Efficient Long Sequence Decoding on Dataflow Accelerators](https://arxiv.org/abs/2511.03092)
...
### [LaMoS: Enabling Efficient Large Number Modular Multiplication through SRAM-based CiM Acceleration](https://arxiv.org/abs/2511.03341)
**作者**：Haomin Li, Fangxin Liu, Chenyang Guan, Zongwu Wang, Li Jiang, Haibing Guan
...
### [AnaFlow: Agentic LLM-based Workflow for Reasoning-Driven Explainable and Sample-Efficient Analog Circuit Sizing](https://arxiv.org/abs/2511.03697)
...
### [AnalogSeeker: An Open-source Foundation Language Model for Analog Circuit Design](https://arxiv.org/abs/2508.10409)
...
### [Harvesting energy consumption on European HPC systems: Sharing Experience from the CEEC project](https://arxiv.org/abs/2511.03029)
**作者**：Kajol Kulkarni, Samuel Kemmler, Anna Schwarz, Gulcin Gedik, Yanxiang Chen, Dimitrios Papageorgiou, Ioannis Kavroulakis, Roman Iakymchuk
...
### [UMDAM: A Unified Data Layout and DRAM Address Mapping for Heterogenous NPU-PIM](https://arxiv.org/abs/2511.03293)
**作者**：Hai Huang, Xuhong Qiang, Weisheng Zhao, Chenchen Liu
...
### [Stone Duality Proofs for Colorless Distributed Computability Theorems](https://arxiv.org/abs/2511.03609)
**作者**：Cameron Calk, Emmanuel Godard
...
### [A General Input-Dependent Colorless Computability Theorem and Applications to Core-Dependent Adversaries](https://arxiv.org/abs/2511.03662)
**作者**：Yannis Coutouly, Emmanuel Godard
...
### [Characterising Global Platforms: Centralised, Decentralised, Federated, and Grassroots](https://arxiv.org/abs/2511.03286)
**作者**：Ehud Shapiro
...
### [Investigating the Impact of Isolation on Synchronized Benchmarks](https://arxiv.org/abs/2511.03533)
...
**作者**：Xiangchen Li, Dimitrios Spatharakis, Saeid Ghafouri, Jiakun Fan, Hans Vandierendonck, Deepu John, Bo Ji, Dimitrios Nikolopoulos
...
### [Proof-of-Social-Capital: A Consensus Protocol Replacing Stake for Social Capital](https://arxiv.org/abs/2505.12144)
**作者**：Juraj Mariani, Ivan Homoliak
...
### [FedRef: Communication-Efficient Bayesian Fine-Tuning using a Reference Model](https://arxiv.org/abs/2506.23210)
**作者**：Taehwan Yoon, Bongjun Choi, Wesley De Neve
