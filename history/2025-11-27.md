# ArXiv 新论文更新（2025-11-27)

### [Opt4GPTQ: Co-Optimizing Memory and Computation for 4-bit GPTQ Quantized LLM Inference on Heterogeneous Platforms](https://arxiv.org/abs/2511.19438)
**作者**：Yaozheng Zhang, Wei Wang, Jie Kong, Jiehan Zhou, Huanqing Cui
...
### [Optimizations on Graph-Level for Domain Specific Computations in Julia and Application to QED](https://arxiv.org/abs/2511.19456)
**作者**：Anton Reinhard, Simeon Ehrig, Ren\'e Widera, Michael Bussmann, Uwe Hernandez Acosta
...
### [Temperature in SLMs: Impact on Incident Categorization in On-Premises Environments](https://arxiv.org/abs/2511.19464)
**作者**：Marcio Pohlmann, Alex Severo, Geft\'e Almeida, Diego Kreutz, Tiago Heinrich, Louren\c{c}o Pereira
...
### [Reducing Latency of LLM Search Agent via Speculation-based Algorithm-System Co-Design](https://arxiv.org/abs/2511.20048)
...
### [STAlloc: Enhancing Memory Efficiency in Large-Scale Model Training with Spatio-Temporal Planning](https://arxiv.org/abs/2507.16274)
...
### [CAMformer: Associative Memory is All You Need](https://arxiv.org/abs/2511.19740)
...
### [Pickle Prefetcher: Programmable and Scalable Last-Level Cache Prefetcher](https://arxiv.org/abs/2511.19973)
...
### [R3A: Reliable RTL Repair Framework with Multi-Agent Fault Localization and Stochastic Tree-of-Thoughts Patch Generation](https://arxiv.org/abs/2511.20090)
...
### [PrefixGPT: Prefix Adder Optimization by a Generative Pre-trained Transformer](https://arxiv.org/abs/2511.19472)
...
**作者**：Ayaka Yorihiro, Griffin Berlstein, Pedro Pontes Garc\'ia, Kevin Laeufer, Adrian Sampson
...
### [QiMeng-CRUX: Narrowing the Gap between Natural Language and Verilog via Core Refined Understanding eXpression](https://arxiv.org/abs/2511.20099)
...
### [Asynchronous Cooperative Optimization of a Capacitated Vehicle Routing Problem Solution](https://arxiv.org/abs/2511.19445)
**作者**：Luca Accorsi, Demetrio Lagan\`a, Federico Michelotto, Roberto Musmanno, Daniele Vigo
...
### [AI-driven Predictive Shard Allocation for Scalable Next Generation Blockchains](https://arxiv.org/abs/2511.19450)
**作者**：M. Zeeshan Haider, Tayyaba Noreen, M. D. Assuncao, Kaiwen Zhang
...
### [Enabling Scientific Workflow Scheduling Research in Non-Uniform Memory Access Architectures](https://arxiv.org/abs/2511.19832)
**作者**：Aurelio Vivas, Harold Castro
...
### [Batch Denoising for AIGC Service Provisioning in Wireless Edge Networks](https://arxiv.org/abs/2511.19847)
**作者**：Jinghang Xu, Kun Guo, Wei Teng, Chenxi Liu, Wei Feng
...
### [Interactive Visualization of Proof-of-Work Consensus Protocol on Raspberry Pi](https://arxiv.org/abs/2511.20391)
**作者**：Anton Ivashkevich, Matija Pi\v{s}korec, Claudio J. Tessone
...
### [Efficient Parallel Implementation of the Pilot Assignment Problem in Massive MIMO Systems](https://arxiv.org/abs/2511.20511)
...
### [AVS: A Computational and Hierarchical Storage System for Autonomous Vehicles](https://arxiv.org/abs/2511.19453)
...
### [SparOA: Sparse and Operator-aware Hybrid Scheduling for Edge DNN Inference](https://arxiv.org/abs/2511.19457)
...
### [Beluga: A CXL-Based Memory Architecture for Scalable and Efficient LLM KVCache Management](https://arxiv.org/abs/2511.20172)
...
### [Systemic approach for modeling a generic smart grid](https://arxiv.org/abs/2511.19460)
**作者**：Sofiane Ben Amor, Guillaume Guerard, Loup-No\'e Levy
...
### [Urban Buildings Energy Consumption Estimation Using HPC: A Case Study of Bologna](https://arxiv.org/abs/2511.19463)
...
### [Towards a future space-based, highly scalable AI infrastructure system design](https://arxiv.org/abs/2511.19468)
**作者**：Blaise Ag\"uera y Arcas, Travis Beals, Maria Biggs, Jessica V. Bloom, Thomas Fischbacher, Konstantin Gromov, Urs K\"oster, Rishiraj Pravahan, James Manyika
...
### [Federated Learning Framework for Scalable AI in Heterogeneous HPC and Cloud Environments](https://arxiv.org/abs/2511.19479)
...
### [Improved Linear-Time Construction of Minimal Dominating Set via Mobile Agents](https://arxiv.org/abs/2511.19880)
...
### [PolarStore: High-Performance Data Compression for Large-Scale Cloud-Native Databases](https://arxiv.org/abs/2511.19949)
**作者**：Qingda Hu, Xinjun Yang, Feifei Li, Junru Li, Ya Lin, Yuqi Zhou, Yicong Zhu, Junwei Zhang, Rongbiao Xie, Ling Zhou, Bin Wu, Wenchao Zhou
...
### [SwitchDelta: Asynchronous Metadata Updating for Distributed Storage with In-Network Data Visibility](https://arxiv.org/abs/2511.19978)
**作者**：Junru Li, Qing Wang, Zhe Yang, Shuo Liu, Jiwu Shu, Youyou Lu
...
### [QiMeng-Kernel: Macro-Thinking Micro-Coding Paradigm for LLM-Based High-Performance GPU Kernel Generation](https://arxiv.org/abs/2511.20100)
...
### [SARA: A Stall-Aware Memory Allocation Strategy for Mixed-Criticality Systems](https://arxiv.org/abs/2511.19991)
**作者**：Meng-Chia Lee, Wen Sheng Lim, Yuan-Hao Chang, Tei-Wei Kuo
